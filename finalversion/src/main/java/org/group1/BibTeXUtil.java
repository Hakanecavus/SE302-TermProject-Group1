...
public class BibTeXUtil {
    ...
    static String[] entryFieldNames = {
        "Address", "Annote", "Author", "Booktitle", "Chapter", "Crossref", "Doi", "Edition", "Editor", "Eprint", "Howpublished", "Institution", "Journal", "Key", "Month", "Note", "Number", "Organization", "Pages", "Publisher", "School", "Series", "Title", "Type", "Url", "Volume", "Year"
    };

    static String[] entryFields = {
        "address", "annote", "author", "booktitle", "chapter", "crossref", "doi", "edition", "editor", "eprint", "howpublished", "institution", "journal", "key", "month", "note", "number", "organization", "pages", "publisher", "school", "series", "title", "type", "url", "volume", "year"
    };
    ...
    public static void format(BibTeXLibrary library, File file) throws IOException {
//        File file = new File(directory + library.getName());
        file.createNewFile();
    ...
    public static Map<String, String> getTableHeaders() {
        ...
        for (int i = 0; i < entryFields.length; i++) {
            headers.put(entryFields[i], entryFieldNames[i]);
        }
    ...
    public static String getIdentifier(String name) {
        Map<String, String> headers = getTableHeaders();
